    ...
    $googleFaqs = [
        ...
        [
            ...
            "answer" => "
                ...
                da Google non consente di rimuovere i contenuti dal Web. Se desideri rimuovere qualcosa dal Web,
        ...
        [
            ...
            "answer" => "
                ...
                In alcuni casi sì. Quando fai clic su un risultato della Ricerca Google, il tuo browser web potrebbe reindirizzare alla pagina web
                ...
                sulla ricerca SSL sono disponibili qui. Le query di ricerca o le informazioni contenute nell'URL referrer potrebbero essere disponibili
                mediante Google Analytics o un'API (Application Programming Interface). Inoltre, gli inserzionisti potrebbero ricevere informazioni relative 
...
<body>
    <div class="container">
        ...
        <?php
            foreach($googleFaqs as $question){

                // creo un div per ogni domanda e risposta
                echo('<div class="questions">');

                    // creo un h2 per le domande
                    echo('<h2>');
                    echo($question['question']);
                    echo('</h2>');

                    // creo un p per le risposte
                    echo('<p>');
